...
const keyword = service.keywords.find(k => k.slug === "surprise-date-with-balloon-decoration-surat")!;

export const metadata: Metadata = {
  title: keyword.metaTitle,
  description: keyword.metaDescription,
  keywords: [keyword.title, "surprise date", "balloon decoration", "Surat", "HIVY"],
